    ...
    def to_planning_system_prompt(self):
        ...
        return "\n".join(
            [
                ...
                "- Use a workspace write or append tool when the user wants a file in the connected workspace to be created, replaced, or changed and you have enough content to do it.",
