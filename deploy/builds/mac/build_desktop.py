...
def print_release_path(version: str) -> None:
    files_root = platform_files_root("macos")
    print(f"Expected macOS release directory: {files_root}")
    print(f"Expected DMG name: horizone-{version}-macos-arm64.dmg")


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build the HORIZONE desktop app for macOS.")
...
def command_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="macOS desktop build helper.")
